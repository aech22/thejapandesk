---
title: "Suica, PASMO & ICOCA: The IC Card Guide for Japan (2026)"
description: "Where to buy an IC card, how much to load, whether your phone works, and why your credit card won't tap the train gates — the honest first-timer guide."
date: '2026-08-04'
updated: '2026-08-04'
pillar: japan-travel
slug: suica-pasmo-icoca-guide
keyword: "suica card japan"
draft: false
---
...
## 1. The pain point: everyone says "get an IC card," nobody explains the basics
...
## 4. How much to load (and topping up)
...
## 5. Does it work on my phone? (the honest device answer)
...
## 7. IC card vs rail pass — they're not the same thing

A common beginner mix-up: an IC card is **not** a rail pass, and you often want **both**.

- The **IC card** is pay-as-you-go for *local* transit and everyday taps — the metro, city buses, konbini.
- A **rail pass** (nationwide or regional) is a separate product for *long-distance* Shinkansen travel between cities.
...
- **First-timer, plastic:** grab a **Welcome Suica/PASMO** (or ICOCA in Kansai) at the airport, load ¥2,000, top up as you go. Simplest possible path.
- **iPhone user:** add **Mobile Suica to Apple Wallet** before you fly; tap your phone, never touch a machine again.
- **Android user:** check your model's support; if unsure, just get the plastic card — it always works.
- **Returning visitor / souvenir keeper:** get a **regular** (deposit) card with no expiry and keep it for next time.
- **Family:** one card per person who taps through gates — you can't share a single card through a gate.

---

## 9. Conclusion + your next step

Strip away the three brand names and the anxiety, and the IC card is simple: **it's a tap-to-pay card you need because your foreign credit card won't open the train gates.** Get any one of Suica/PASMO/ICOCA at the airport or any station machine (skip the counter hunt), load about ¥2,000, top up in small amounts, and tap it for trains, buses, konbini, and more. iPhone users can carry it in Apple Wallet; Android users should check their model.

That's your day-one setup sorted. The next two "before you tap anything" decisions are data and long-distance rail:

1. Get online first: [best eSIM for Japan](/japan-travel/best-esim-for-japan/) — because your IC card handles gates, but your phone handles *everything else*.
2. Decide long-distance rail separately: [Is the JR Pass Worth It in 2026?](/japan-travel/is-jr-pass-worth-it-2026/).
